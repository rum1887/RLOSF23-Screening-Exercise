...
Opens the bash/zsh shell
- `vi ./zshrc` 
Paste the build location to the shell.
- `export PATH="/Users/ramya/vowpal_wabbit/build/vowpalwabbit/cli:$PATH"`. 
Refresh the shell to record the changes.
- `Source ./zshrc`. 
...
3. _Pass an int variable to Lua and print out the value in Lua_ <br><br>Output(1)<br><br><img width="1281" alt="Screenshot 2023-03-31 at 5 42 28 AM" src="https://user-images.githubusercontent.com/57267583/228991650-fae4ae07-802a-4f83-b875-9dc7abd98df0.png">
4. _Change value of an int variable in Lua and print it out in C++_<br><br>Output(1)<br><br><img width="1284" alt="Screenshot 2023-03-31 at 5 44 06 AM" src="https://user-images.githubusercontent.com/57267583/228991797-f1994e88-7b92-413d-884d-b12ad097dfb2.png">
### Instructions to build and run
